											...
											{section name=dataCustomer loop=$dataCustomer}
												<tr>
													...
													<td>
														...
														<a title="Delete" href="customers.php?module=customer&act=delete&customerID={$dataCustomer[dataCustomer].customerID}&page={$page}" onclick="return confirm('Anda Yakin ingin menghapus DATA {$dataCustomer[dataCustomer].customerName}?');"><img src="img/icons/delete.png" width="18"></a>
													</td>
												</tr>
											{/section}
										</tbody>
