					...
					<div class="box box-primary">
						...
						{elseif $module == 'payin' AND $act == 'finish'}
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_paysps.php?module=payin&act=print&invoiceNo={$invoiceNo}&paymentNo={$paymentNo}&paymentID={$paymentID}" target="_blank"><button class="btn btn-default pull-right">Print</button></a>
						...
						{elseif $module == 'paysps' AND $act == 'detailpaysps'}
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_paysps.php?module=paysps&act=print&invoiceNo={$invoiceNo}&paymentNo={$paymentNo}&paymentID={$paymentID}" target="_blank"><button class="btn btn-default pull-right">Print</button></a>
										{if $q != ''}
											<a href="pay_sps.php?module=paysps&act=search&q={$q}"><button class="btn btn-default pull-right">Back</button></a>
										{else}
											<a href="pay_sps.php?page={$page}"><button class="btn btn-default pull-right">Back</button></a>
										{/if}
									</div>
								</div>
							</div><!-- /.box-header -->
						...
						{elseif $module == 'paysps' AND $act == 'search'}
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="pay_sps.php">
											...
											<a href="print_pay_sps.php?act=print&q={$q}&startDate={$startDate}&endDate={$endDate}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print PDF</button></a>
											&nbsp;&nbsp;&nbsp;
										</form>
									</div>
								</div>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>
														<a title="Detail" href="pay_sps.php?module=paysps&act=detailpayin&paymentID={$dataPay[dataPay].paymentID}&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&q={$q}&page={$page}"><img src="img/icons/view.png" width="18"></a>
														<a title="Delete" href="pay_sps.php?module=paysps&act=delete&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&paymentID={$dataPay[dataPay].paymentID}&q={$q}" onclick="return confirm('Anda Yakin ingin membatalkan nomor pembayaran {$dataPay[dataPay].paymentNo}? penghapusan ini akan membatalkan pembayaran transaksi ini.');"><img src="img/icons/delete.png" width="18"></a>
													</td>
												</tr>
											{/section}
										</tbody>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>{$dataPay[dataPay].staffName}</td>
													<td>
														<a title="Detail" href="pay_sps.php?module=paysps&act=detailpayin&paymentID={$dataPay[dataPay].paymentID}&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&page={$page}"><img src="img/icons/view.png" width="18"></a>
