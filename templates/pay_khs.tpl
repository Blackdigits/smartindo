	...
	<script>
		...
		$(document).ready(function() {
			...
			$('#invoiceNo').change(function () {
				...
				window.location.href = "pay_khs.php?module=paykhs&act=add&invoiceNo=" + invoiceNo;
			});
		});
	</script>
{/literal}
			...
			<div class="row">
				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="box box-primary">
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="pay_khs.php" onclick="return confirm('Anda Yakin ingin membatalkan pembayaran transaksi penjualan ini?');"><button type="button" class="btn btn-default pull-right">Batal Trx</button></a>
									</div>
								</div>
							</div><!-- /.box-header -->
						...
						{elseif $module == 'paykhs' AND $act == 'finish'}
							{literal}
								<script>
									window.location.hash="no-back-button";
									window.location.hash="Again-No-back-button";//again because google chrome don't insert first hash into history
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_paykhs.php?module=paykhs&act=print&invoiceNo={$invoiceNo}&paymentNo={$paymentNo}&paymentID={$paymentID}" target="_blank"><button class="btn btn-default pull-right">Print</button></a>
										<a href="pay_khs.php"><button class="btn btn-default pull-right">Close</button></a>
									</div>
								</div>
							</div><!-- /.box-header -->
						...
						{elseif $module == 'paykhs' AND $act == 'detailpayout'}
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										<a href="print_unit_paykhs.php?module=paykhs&act=print&invoiceNo={$invoiceNo}&paymentNo={$paymentNo}&paymentID={$paymentID}" target="_blank"><button class="btn btn-default pull-right">Print</button></a>
										{if $q != ''}
											<a href="pay_khs.php?module=paykhs&act=search&q={$q}"><button class="btn btn-default pull-right">Back</button></a>
										{else}
											<a href="pay_khs.php?page={$page}"><button class="btn btn-default pull-right">Back</button></a>
										{/if}
									</div>
								</div>
							</div><!-- /.box-header -->
						...
						{elseif $module == 'paykhs' AND $act == 'search'}
							...
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="pay_khs.php">
											<input type="hidden" name="module" value="paykhs">
											...
											<a href="pay_khs.php?module=paykhs&act=add" style="float: left;"><button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add</button></a>
											<a href="print_pay_khs.php?act=print&q={$q}&startDate={$startDate}&endDate={$endDate}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print PDF</button></a>
											&nbsp;&nbsp;&nbsp;
										</form>
									</div>
								</div>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>
														<a title="Detail" href="pay_khs.php?module=paykhs&act=detailpayout&paymentID={$dataPay[dataPay].paymentID}&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&q={$q}&page={$page}"><img src="img/icons/view.png" width="18"></a>
														<a title="Delete" href="pay_khs.php?module=paykhs&act=delete&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&paymentID={$dataPay[dataPay].paymentID}&q={$q}" onclick="return confirm('Anda Yakin ingin membatalkan nomor pembayaran {$dataPay[dataPay].paymentNo}? penghapusan ini akan membatalkan pembayaran transaksi ini.');"><img src="img/icons/delete.png" width="18"></a>
													</td>
												</tr>
											{/section}
										</tbody>
								...
								<div class="box-tools pull-right">
									<div class="box-footer clearfix no-border">
										...
										<form method="GET" action="pay_khs.php">
											...
											<a href="pay_khs.php?module=paykhs&act=add" style="float: left;"><button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add</button></a>
											<a href="print_pay_khs.php?act=print&q={$q}" style="float: left;" target="_blank"><button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print PDF</button></a>
											&nbsp;&nbsp;&nbsp;
										</form>
									</div>
								</div>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>{$dataPay[dataPay].staffName}</td>
													<td>
														<a title="Detail" href="pay_khs.php?module=paykhs&act=detailpayout&paymentID={$dataPay[dataPay].paymentID}&invoiceNo={$dataPay[dataPay].invoiceNo}&paymentNo={$dataPay[dataPay].paymentNo}&page={$page}"><img src="img/icons/view.png" width="18"></a>
