...
{if $module == 'assembly' AND $act == 'edit'}
			...
			<td>
				...
				<table cellpadding="3" cellspacing="3">
					<tr>
						...
						<td width="5">:</td>
						<td><input type="text" id="productBarcode" value="{$productCode}" name="productBarcode" class="form-control" style="width: 360px;" DISABLED></td>
					</tr>
					<tr>
						<td colspan="2"></td>
