			...
			<td>
				...
				<table cellpadding="3" cellspacing="3">
					...
					<tr>
						...
						<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" id="staffName" value="{$staffName}" name="staffName" class="form-control" placeholder="Nama Pegawai" style="width: 270px;" required></td>
						<td></td>
					...
					<tr>
						...
						<td>
							<select id="level" name="level" class="form-control" style="width: 270px;" required>
								...
								<option value="2" {if $level == '2'} SELECTED {/if}>Gudang</option>
					...
					<tr>
						...
						<td style="font-size: 14px; background-color: #FFFFFF;">:</td>
						<td style="border-right: 1px solid #000000; background-color: #FFFFFF;"><input type="text" id="phone" value="{$phone}" name="phone" class="form-control" placeholder="Nomor Telepon / HP" style="width: 270px;"></td>
						<td></td>
						<td colspan="3"></td>
					</tr>
					<tr>
