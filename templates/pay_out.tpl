							...
							<div class="box-body">
								...
								<table cellpadding="3" cellspacing="3" width="100%">
									...
									<tr valign="top">
										<td>TERHUTANG</td>
										<td>:</td>
										<td><input type="text" id="receive" name="receive" value="{$receive}" class="form-control" placeholder="Total Piutang" style="width: 300px;"></td>
									</tr>
									<tr>  
										...
										<td><select id="customerName" name="customerName" class="form-control" style="width: 300px;" required>
												...
												{section name=dataCustomer loop=$dataCustomer}
													{if $dataCustomer[dataCustomer].customerID == $customerID}
														<option value="{$dataCustomer[dataCustomer].customerName}" SELECTED>{$dataCustomer[dataCustomer].customerName} [{$dataCustomer[dataCustomer].customerCode}]</option>
													{else}
														<option value="{$dataCustomer[dataCustomer].customerName}">{$dataCustomer[dataCustomer].customerName} [{$dataCustomer[dataCustomer].customerCode}]</option>
													{/if}
												{/section}
											</select> 
										</td>
										...
										<tbody>
											{section name=dataPay loop=$dataPay}
												<tr>
													...
													<td>{$dataPay[dataPay].customerName}</td>
													<td>
