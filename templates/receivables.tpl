					...
					<div class="box box-primary">
						...
						{elseif $module == 'receivable' AND $act == 'history'}
							...
							<div class="box-body" style="float: left; background-color: #FFF;">
                                ...
                                <input type="hidden" name="sfaid" id="receiveID" value="{$salesId}">
								<input type="hidden" name="sfaname" id="receiveNo" value="{$salesName}">
								...
								<table cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
										...
										<td>:</td>
										<td>
                                            <input type="hidden" value="{$salesId}" name="salesId" id="salesId"  class="form-control" style="width: 270px;" DISABLED>
                                            <input type="text" value="{$salesName}" name="salesName" id="salesName" class="form-control" placeholder="Nama Sales" style="width: 270px;" DISABLED>
										</td>
									</tr>
									<tr>
										<td>TOTAL PIUTANG</td>
                                    ...
                                    <tr>
										<td>PAJAK</td>
										<td>:</td>
										<td><input type="text" id="pajak" name="pajak" class="form-control" placeholder="Penambahan Pajak" value="{$pajak}" style="width: 270px;" DISABLED></td>
									</tr>
									<tr>
										<td>SISA PIUTANG</td>
										<td>:</td>
