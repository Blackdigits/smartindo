...
if ($_SESSION['staffID'] == '' && $_SESSION['email'] == '')
{
	...
	if ($act == 'print')
	{
		...
		$content = "<table style='padding-bottom: 10px; width: 240mm;'>
						...
						<tr valign='top'>
							<td>
								<span style='font-size: 11pt;'><b>REKAP SALES ORDER</b></span>
							</td>
						</tr>
					</table>
					<table cellpadding='0' cellspacing='0' style='width: 290mm;'>
						<tr>
							...
							<th style='width: 20mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>NO FAKTUR</th>
							...
							<th style='width: 17mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>TOKO</th>
							<th style='width: 10mm; padding: 5px 0px 5px 0px; font-size: 9pt; border-top: 1px solid #000; border-bottom: 1px solid #000;'>NO</th>
						...
						while ($dtSo = mysqli_fetch_array($sqlSo))
						{
							...
							$content .= "
									<tr valign='top'>
										...
										<td style='padding: 2px 0px 2px 0px; font-size: 9pt;'>$dtSo[soFaktur]</td>
