...
{
	$queryAuthorizeStaff = "SELECT * FROM as_modules WHERE modulID = '30'";
	...
	// if module is pay sps and action is delete
	if ($module == 'paysps' && $act == 'delete')
	{
	...
	elseif ($module == 'paysps' && $act == 'input')
	{
	...
	elseif ($module == 'paysps' && $act == 'detailpayin')
	{
		$paymentID = $_GET['paymentID'];
		$paymentNo = $_GET['paymentNo'];
		$invoiceNo = $_GET['invoiceNo'];
	...
	elseif ($module == 'paysps' && $act == 'finish')
	{
		$paymentNo = $_GET['paymentNo'];
		$paymentID = $_GET['paymentID'];
		$invoiceNo = $_GET['invoiceNo'];
		...
		$smarty->assign("breadcumbTitle", "Pembayaran Transaksi Khusus");
		$smarty->assign("breadcumbTitleSmall", "Halaman untuk melakukan pembayaran transaksi pembelian khusus.");
		$smarty->assign("breadcumbMenuName", "Transaksi Khusus");
		$smarty->assign("breadcumbMenuSubName", "Pembayaran Transaksi Khusus");
	}
	
	// if the module in and act is add
	elseif ($module == 'paysps' && $act == 'add')
	{
		...
		$smarty->assign("breadcumbTitle", "Transaksi Khusus");
		$smarty->assign("breadcumbTitleSmall", "Halaman untuk melakukan transaksi khusus, faktur pembelian khusus.");
		$smarty->assign("breadcumbMenuName", "Transaksi Khusus");
		$smarty->assign("breadcumbMenuSubName", "Transaksi Pembelian Khusus");
	}

	elseif ($module == 'paysps' && $act == 'search')
	{
		$q = mysqli_real_escape_string($connect, $_GET['q']);
		...
		$smarty->assign("breadcumbTitle", "Pembayaran Transaksi Khusus");
		$smarty->assign("breadcumbTitleSmall", "Halaman untuk melakukan pembayaran transaksi khusus.");
		$smarty->assign("breadcumbMenuName", "Transaksi Khusus");
		$smarty->assign("breadcumbMenuSubName", "Pembayaran Transaksi Khusus");
	}
